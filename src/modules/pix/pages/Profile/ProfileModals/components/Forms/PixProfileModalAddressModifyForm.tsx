...
const PixProfileModalAddressModifyForm = ({
  buttonText,
  closeModal,
}: {
  buttonText: string;
  ...
  useEffect(() => {
    setValue("address", profile?.infos?.address, { shouldValidate: true });
    setValue("zipcode", profile?.infos?.zipcode, { shouldValidate: true });
    setValue("city", profile?.infos?.city, { shouldValidate: true });
    setValue("country", profile?.infos?.country, { shouldValidate: true });
  }, []);
...
export default PixProfileModalAddressModifyForm;
